...
%ifarch %{arm}
cmake -DMUPENPLUSAPI=On -DGLES2=On -DNEON_OPT=1 -DCMAKE_CXX_FLAGS="-ftree-vectorize -mvectorize-with-neon-quad -ftree-vectorizer-verbose=2 -funsafe-math-optimizations -fno-finite-math-only" ..
%endif
%ifarch %{ix86}
